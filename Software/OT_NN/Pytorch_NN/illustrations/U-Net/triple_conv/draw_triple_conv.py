...
# Remonter au dossier racine de PlotNeuralNet
ROOT = Path(r'C:\Users\maxen\Documents\Stage\PlotNeuralNet')
sys.path.insert(0, str(ROOT))

from pycore.tikzeng import *
from pycore.blocks  import *

OUTPUT_DIR   = r'C:\Users\maxen\Documents\Stage\Software\OT_NN\Pytorch_NN\illustrations\U-Net\triple_conv'
...
arch = [
    ...
    # Bottleneck
    to_ConvConvConvRelu("bottleneck", " ", (" "," ", " "),
            offset="(1,0,0)", to="(pool3-east)",
            height=8, depth=8, width=(8,8,8)),

    # Decoder
    to_UnPool("unpool3",
              offset="(2,0,0)", to="(bottleneck-east)",
              height=16, depth=16, width=1, opacity=0.8),

    to_ConvConvConvRelu("dec3", " ", (" "," ", " "),
    ...
    to_connection("bottleneck",  "unpool3"),
...
to_generate(arch, 'unet_triple_conv.tex')

with open('unet_triple_conv.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
# ── Write & compile ───────────────────────────────────────────────────────────
with open('unet_triple_conv.tex', 'w', encoding='utf-8') as f:
    f.write(content)

os.system('pdflatex unet_triple_conv.tex')
os.system('start unet_triple_conv.pdf')