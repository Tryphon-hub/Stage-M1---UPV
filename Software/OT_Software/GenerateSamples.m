function GenerateSamples(Folder,FileName,TractionFile,GenerateNewTractons,Net,NumSamples)
clc
...
delete('Square.msh')
CallString = ['"C:\Program Files (x86)\gmsh-4.13.1-Windows64\gmsh" ' GeoFileName ' - -setnumber numLayers 32 -o Square.msh '];
...
if NumSamples == -1
    ...
    Tractions = GenerateTractions(NumSamples,[Folder '\' TractionFile],GenerateNewTractons);
